...
const Usage = () => {
    return (
        <>
            <div className='main_div' style={{marginBottom:'80px'}}>
                ...
                <div className='ryt_div'>
                    ...
                    <div style={{ textAlign: 'left', fontSize: "25px", paddingTop: '0px', fontWeight: "700" , marginLeft:"5px"}}>How to use the App?</div>
                    <br />
                    {
                       WorkApi.map((elem) => {
